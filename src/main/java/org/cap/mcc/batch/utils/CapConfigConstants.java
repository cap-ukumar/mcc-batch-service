package org.cap.mcc.batch.utils;
...
public class CapConfigConstants {
	...
	public static final String SCHEDULE_DETAILS_ENDPOINT = "/schedule-process";
	public static final String UPDATE_SCHEDULE_ENDPOINT = "/schedule-process-details";
